...
class StrategySelector:
    ...
    def __init__(self, api_connector, order_handler, config_manager):
        ...
        self.strategy_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)))
    ...
    def _discover_strategies(self):
        ...
        for filename in os.listdir(self.strategy_dir):
            if filename.endswith(".py") and not filename.startswith("_") and filename != "strategy_selector.py":
